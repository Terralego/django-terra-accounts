...
urlpatterns += [
    ...
    # reset lost password
    path('auth/password_reset/', base_auth_views.PasswordResetView.as_view(
    ...
    path('auth/password_reset/done/', base_auth_views.PasswordResetDoneView.as_view(), name='password_reset_done'),
